      ...
      if (fs.existsSync(metadataPath)) {
        ...
        try {
          ...
          if (!metadataContent.trim()) {
            // metadata.json is empty, fill it with default values
            metadata = {
          ...
          console.error(`Failed to read metadata from ${metadataPath}:`, err.message);
          continue;
        }
        ...
        if (dbProjectsMap.has(projectId)) {
          ...
          if (project.path !== folderPath) {
            ...
            await project.update({ path: folderPath, name: projectName });
          }
          ...
          await project.update({ id: projectId, name: projectName, authorName });
